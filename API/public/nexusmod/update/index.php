...
// check if ID already exists, and if so, determine if it's got one of the required values for update
$sql = $conn->prepare("SELECT category_name FROM skyrim WHERE mod_id=?");
